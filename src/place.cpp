...
void Place_data::construct(const boost::property_tree::ptree& tree) {
    attributes = Place_attributes{tree.get_child("attributes", boost::property_tree::ptree())};
    bounding_box = Bounding_box{tree.get_child("bounding_box", boost::property_tree::ptree())};
